...
int main()
{
    ...
    case 1:
    {
        ...
        printf("请输入在x轴方向的位移量(以像素为单位):\n");

        scanf("%d", &xOffset);

        printf("请输入在y轴方向的位移量(以像素为单位):\n");
    ...
    case 3:
    {
        ...
        printf("请输入x轴方向(水平方向)的缩放比率:\n");

        scanf("%lf", &x_ratio);

        printf("请输入y轴方向(竖直方向)的缩放比率:\n");
    ...
    case 5:
    {
        ...
        printf("请选择镜像翻转的方向(输入序号):\n");
        printf("0->以x轴为对称轴镜像翻转\n");
        printf("1->以y轴为对称轴镜像翻转\n");
